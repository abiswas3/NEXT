...
alg_ids = ['RandomSampling','RandomSampling']
...
initExp['args']['instructions'] = "Drag the center molecule towards either the left or right molecule to indicate which it is most similar to. Leaving the molecule in the center indicates even similarity between the options. Dragging the center molecule entirely to one side indicates that the two molecules are very similar. There are no right or wrong answers."
initExp['args']['debrief'] = 'THANK YOU '
initExp['args']['num_tries'] = 10

# Which app are we running? (examples of other algorithms are in examples/
initExp['app_id'] = 'PoolBasedTripletsSlider'
...
experiment['primary_target_file'] = '{}/molecules.zip'.format(curr_dir)
