"""
PoolBasedTripletsSlider app of the Online Learning Library for Next.Discovery
author: Kevin Jamieson, kevin.g.jamieson@gmail.com
last updated: 1/17/2015

PoolBasedTripletsSliderPrototype

This interface must be implemented by an app that solves the pool-based non-metric multidimensional scaling problem. Algorithms solving this problem are managed by PoolBasedTripletsSlider.py
"""


class PoolBasedTripletsSliderPrototype(object):
  def __init__(self): 
    self.app_id = 'PoolBasedTripletsSlider'
